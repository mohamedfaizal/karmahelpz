...
<link rel="stylesheet" type="text/css" href="demodistrict.css" />
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
<script type="text/javascript" src="scriptdistrict.js"></script>
...
<form id="regForm" action="submitdistrict.php" method="post">
...
<table>
  ...
  <tr>
  <td>&nbsp;</td>
  <td><input type="submit" class="greenButton" value="Sign Up" /><img id="loading" src="imgdistrict/ajax-loader.gif" alt="working.." />
</td>
  </tr>
