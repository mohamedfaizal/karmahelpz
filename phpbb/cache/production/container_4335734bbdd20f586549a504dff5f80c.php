...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000073d3ac9e0000000008396c8d(
...
class phpbbtemplatetwiglexer_0000000073d3ac9e0000000008396c8d extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58b512545e2a9624845507 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58b512545e2a9856440295 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58b512545dec1978181490 = array(
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, 'set_environment', array('env' => $env), $this->initializer58b512545e2a9856440295);

        return $this->valueHolder58b512545e2a9624845507->set_environment($env);
    }
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer58b512545e2a9856440295);

        return $this->valueHolder58b512545e2a9624845507->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer58b512545e2a9856440295);

        return $this->valueHolder58b512545e2a9624845507->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer58b512545e2a9856440295 = $initializer;
    }
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, '__get', array('name' => $name), $this->initializer58b512545e2a9856440295);

        if (isset(self::$publicProperties58b512545dec1978181490[$name])) {
            return $this->valueHolder58b512545e2a9624845507->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58b512545e2a9624845507;
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58b512545e2a9856440295);
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, '__isset', array('name' => $name), $this->initializer58b512545e2a9856440295);
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, '__unset', array('name' => $name), $this->initializer58b512545e2a9856440295);
    ...
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, '__clone', array(), $this->initializer58b512545e2a9856440295);

        $this->valueHolder58b512545e2a9624845507 = clone $this->valueHolder58b512545e2a9624845507;
    }

    public function __sleep()
    {
        $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, '__sleep', array(), $this->initializer58b512545e2a9856440295);

        return array('valueHolder58b512545e2a9624845507');
    }
    ...
    {
        return $this->initializer58b512545e2a9856440295;
    }
    ...
    {
        return $this->initializer58b512545e2a9856440295 && $this->initializer58b512545e2a9856440295->__invoke($this->valueHolder58b512545e2a9624845507, $this, 'initializeProxy', array(), $this->initializer58b512545e2a9856440295);
    }
    ...
    {
        return null !== $this->valueHolder58b512545e2a9624845507;
    }
    ...
    {
        return $this->valueHolder58b512545e2a9624845507;
    }
