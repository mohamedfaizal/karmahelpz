...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000065395afa0000000003075288(
...
class phpbbtemplatetwiglexer_0000000065395afa0000000003075288 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58b51265e6c2c520243316 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58b51265e7014519522251 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58b51265e6c2c613420434 = array(
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, 'set_environment', array('env' => $env), $this->initializer58b51265e7014519522251);

        return $this->valueHolder58b51265e6c2c520243316->set_environment($env);
    }
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer58b51265e7014519522251);

        return $this->valueHolder58b51265e6c2c520243316->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer58b51265e7014519522251);

        return $this->valueHolder58b51265e6c2c520243316->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer58b51265e7014519522251 = $initializer;
    }
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, '__get', array('name' => $name), $this->initializer58b51265e7014519522251);

        if (isset(self::$publicProperties58b51265e6c2c613420434[$name])) {
            return $this->valueHolder58b51265e6c2c520243316->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58b51265e6c2c520243316;
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58b51265e7014519522251);
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, '__isset', array('name' => $name), $this->initializer58b51265e7014519522251);
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, '__unset', array('name' => $name), $this->initializer58b51265e7014519522251);
    ...
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, '__clone', array(), $this->initializer58b51265e7014519522251);

        $this->valueHolder58b51265e6c2c520243316 = clone $this->valueHolder58b51265e6c2c520243316;
    }

    public function __sleep()
    {
        $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, '__sleep', array(), $this->initializer58b51265e7014519522251);

        return array('valueHolder58b51265e6c2c520243316');
    }
    ...
    {
        return $this->initializer58b51265e7014519522251;
    }
    ...
    {
        return $this->initializer58b51265e7014519522251 && $this->initializer58b51265e7014519522251->__invoke($this->valueHolder58b51265e6c2c520243316, $this, 'initializeProxy', array(), $this->initializer58b51265e7014519522251);
    }
    ...
    {
        return null !== $this->valueHolder58b51265e6c2c520243316;
    }
    ...
    {
        return $this->valueHolder58b51265e6c2c520243316;
    }
